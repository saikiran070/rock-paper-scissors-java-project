...
let currentRound = 1;
const totalRound = 5; // You can adjust this number based on how long you want the game to be
...
function concludeGame() {
    ...
    gameConclusion.innerHTML =
        <><h2>Game Over</h2><><p>${finalMessage}</p><p>Final Score - You: ${playerScore} │ Computer: ${computerScore}</p><button id="restart-btn">Restart Game</button></></>
